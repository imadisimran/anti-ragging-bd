                  ...
                  <div>
                   ...
                   {selectedReport.proofUrls && selectedReport.proofUrls.length > 0 ? (
                    <div>
                      ...
                      <div
                        onClick={() => setActiveProofUrl(selectedReport.proofUrls[0])}
                      ...
                      >
                        {getProofType(selectedReport.proofUrls[0]) === "video" ? (
                          <div className="w-full h-full bg-slate-950 flex items-center justify-center relative">
                            <video src={selectedReport.proofUrls[0]} className="w-full h-full object-cover opacity-60" muted />
                        ...
                        ) : getProofType(selectedReport.proofUrls[0]) === "audio" ? (
                        ...
                        {getProofType(selectedReport.proofUrls[0]) === "image" && (
                          <div className="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                            <span className="bg-white/90 text-primary px-4 py-2 font-bold text-label-md flex items-center gap-2 rounded shadow">
